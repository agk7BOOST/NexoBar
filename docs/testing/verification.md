...
La futura implementación de Slice 8 verifica proporcionalmente publicación SSE sólo después de commit, silencio ante rollback, autorización exacta por destino y terminación por pérdida de autoridad; en frontend, fencing de generación, coalescing/duplicados, refresh tras reconexión e intents inciertos sin resolución por SSE; y un E2E de dos navegadores para frescura de Preparation. La decisión y el alcance están en [SSE y frescura multiusuario](../architecture/sse-and-freshness.md).
