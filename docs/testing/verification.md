...
El checkpoint SSE de Inventory pendiente para Slice 8 usará dos Identities/Sessions con `InventoryOperation`: A mantendrá abierto el listado operacional con Item X en 10; B registrará Entry +5 por UI; A deberá ver 15 sin reload, refresh manual ni API de mutación directa, mediante invalidación y GET operacional autoritativo. Es evidencia planificada, no un resultado de prueba ejecutado.
