...
- OperationalIntervention INT-01..INT-07 está implementada verticalmente en S7-I6D. Cancellation completa de Order, semántica física de desperdicio/descarte/recuperación, Applied Price Correction, reparación post-Liquidation y SSE permanecen en [pendientes](pending.md).
