...
namespace NexoBar.Inventory.Migrations
{
    ...
    [Migration("20260904023608_AddEverydayInventoryMovements")]
    partial class AddEverydayInventoryMovements
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("inventory_movements", "inventory", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_inventory_movements_reconciliation_count", "(nature = 'Reconciliation' AND count_observation_id IS NOT NULL) OR (nature <> 'Reconciliation' AND count_observation_id IS NULL)");

                            t.HasCheckConstraint("CK_inventory_movements_reconciliation_quantity", "(nature = 'Reconciliation' AND quantity >= 0) OR (nature IN ('Entry', 'ManualExit', 'Waste') AND quantity > 0) OR nature = 'Correction'");
            ...
            modelBuilder.Entity("NexoBar.Inventory.InventoryMovementCommand", b =>
                {
                    ...
                    b.Property<decimal?>("IntentQuantity")
                        .HasColumnType("numeric(28,12)")
