...
public sealed class OrderOperationsApiFixture : IAsyncLifetime
{
    ...
    internal async Task ResetAsync(CancellationToken cancellationToken)
    {
        ...
        await dbContext.Database.ExecuteSqlRawAsync(
            """
            TRUNCATE TABLE
                order_operations.applied_price_correction_commands,
                order_operations.applied_price_correction_history,
                order_operations.content_applied_price_states,
                order_operations.complete_cancellation_commands,
                order_operations.complete_cancellation_details,
                order_operations.order_cancellation_states,
                order_operations.complete_cancellation_history,
                order_operations.content_cancellation_commands,
                order_operations.content_cancellation_history,
                order_operations.content_correction_commands,
                order_operations.content_correction_history,
